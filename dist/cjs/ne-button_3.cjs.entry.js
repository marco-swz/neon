...
const NeonButton = class {
    ...
    */
    variant;
    render() {
        return (index.h("a", { key: 'ccca4ae27426c208383e951349303138077b1bb1', href: this.href }, index.h("button", { key: 'a507b7a939977df3c677ce1f7a5dc9d43a5ca3ed', id: "ne-button", onClick: this.handleClickButton }, index.h("slot", { key: '0eda5ef25371e75a2728d03a4efa37e3c77a23dd' }))));
    }
...
const NeonDialog = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.dialogOpened = index.createEvent(this, "dialogOpened");
        this.dialogClosed = index.createEvent(this, "dialogClosed");
    }
    refs = {
        dialog: null
    };
    ...
    */
    titleText = '';
    render() {
        return (index.h("dialog", { key: '1fd3e064f013ea98e55c67d342c51763d222fca3', id: "ne-diag-outer", ref: ($el) => this.refs.dialog = $el }, index.h("div", { key: '1d5f3d2d1d80769c28e2bbedff091288fa7f9a61', id: "ne-diag-inner" }, index.h("div", { key: '46f1cc18e1eea3077551fcd02b9d6a1c471f3e6d', id: "ne-diag-header" }, index.h("div", { key: 'd15357ed9477f1bc257501bfb7f5465f25473d01', id: "ne-title" }, index.h("slot", { key: '0179709eec726568029846774887aa22dbaba59f', name: "title" }, this.titleText)), index.h("div", { key: '8ca0c3bcce7b02c0521e4663393559397f53509a', id: "ne-icon-close", onClick: () => this.close() }, index.h("span", { key: '544bf371883e4f8a105ac3d17f0f716ae443a605' }, "X"))), index.h("div", { key: 'bc9c8691de88006345ece7a7f0c5a99d69f5fc96', id: "ne-diag-body" }, index.h("slot", { key: '9984e690601491a813ceb1c3351bdb7017349523' }), index.h("slot", { key: 'c0873ab74fb04795a73b77ef328e5a009cbe4e5a', name: "body" })), index.h("div", { key: '1ae9c844659906b9f9093ae482e68dca9d5ebf93', id: "ne-diag-footer" }, index.h("slot", { key: '84ed28d1c222a63a66e50213f54f33a388db1cf5', name: "footer" })))));
    }
    watchOpen(newValue) {
        if (newValue) {
...
exports.ne_button = NeonButton;
exports.ne_dialog = NeonDialog;
exports.ne_input = NeonInput;
